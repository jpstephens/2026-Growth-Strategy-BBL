      ...
      <div className="w-full max-w-6xl space-y-xl">
        ...
        <motion.div variants={itemVariants} className="text-center">
          ...
          <p className="text-lg text-bb-slate-600 max-w-3xl mx-auto">
            <span className="font-bold text-bb-navy-900">Operations is the backbone.</span> Without excellent execution, sales means nothing.
          </p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="bg-gradient-to-br from-bb-emerald-50 to-white rounded-xl border-2 border-bb-emerald-300 p-xl shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-bold text-bb-emerald-700 mb-xs">Your Domain</h3>
              <p className="text-3xl font-display font-black text-bb-navy-900">{davidGrowthPath.domain}</p>
              <p className="text-sm text-bb-slate-600 mt-xs">You set the priorities. You own the process.</p>
            </div>
            <div className="text-right">
              <p className="text-sm text-bb-slate-600 mb-sm font-semibold">Performance Targets</p>
              <div className="space-y-xs">
                <p className="text-sm"><span className="font-bold text-bb-navy-900">{davidGrowthPath.targets.onTimeRate}%</span> on-time</p>
                <p className="text-sm"><span className="font-bold text-bb-navy-900">{davidGrowthPath.targets.carrierRetention}%</span> carrier retention</p>
                <p className="text-sm"><span className="font-bold text-bb-navy-900">{davidGrowthPath.targets.customerSatisfaction}%</span> satisfaction</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="bg-gradient-to-br from-bb-sunset-500 to-bb-sunset-600 rounded-2xl p-xl shadow-lg border-2 border-bb-sunset-400 text-white">
          ...
          <div className="flex items-center gap-md">
            ...
            <div className="flex-1 text-center p-md bg-white/10 rounded-xl">
              <p className="text-xs text-white/80 mb-xs">150+ loads/month</p>
              <p className="text-sm font-bold">+ Ops Coordinator</p>
            </div>
            <div className="text-xl text-white/60">→</div>
            <div className="flex-1 text-center p-md bg-white/20 rounded-xl border border-white/30">
              <p className="text-xs text-white/90 mb-xs">200+ loads/month</p>
              <p className="text-sm font-bold">Operations Manager</p>
            </div>
          </div>
