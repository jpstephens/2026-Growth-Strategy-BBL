    ...
    <Slide variant="gradient">
      <div className="w-full max-w-6xl space-y-2xl">
        ...
        <div className="text-center mb-lg">
          ...
          <div className="w-24 h-1.5 bg-gradient-to-r from-bb-forest-500 to-bb-charcoal-500 mx-auto rounded-full mb-lg" />
        ...
        <div className="bg-white rounded-2xl border-2 border-bb-charcoal-200 p-2xl shadow-lg">
          <h3 className="text-xl font-bold text-bb-charcoal-900 mb-xl">Phase 3 End State (September 30)</h3>
          <div className="grid grid-cols-2 gap-2xl">
            <div className="rounded-xl bg-gradient-to-br from-bb-forest-50 to-white border-2 border-bb-forest-200 p-lg">
              ...
              <p className="text-4xl font-black font-display text-bb-forest-700">50-55</p>
            </div>
            <div className="rounded-xl bg-gradient-to-br from-bb-charcoal-50 to-white border-2 border-bb-charcoal-200 p-lg">
              <p className="text-sm text-bb-slate-600 font-semibold mb-md">Monthly Profit</p>
              <p className="text-4xl font-black font-display text-bb-charcoal-700">$60-65K</p>
            </div>
          </div>
        </div>
      </div>
