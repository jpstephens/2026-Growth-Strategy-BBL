  ...
  return (
    <Slide>
      <div className="w-full max-w-6xl">
        <h2 className="text-5xl font-bold text-bb-black mb-sm text-center">Destructive Lanes</h2>
        <p className="text-xl text-bb-dark-gray text-center mb-lg">Lanes to avoid or reprice</p>
